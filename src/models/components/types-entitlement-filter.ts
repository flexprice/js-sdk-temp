...
} from "./types-entitlement-entity-type.js";
import {
  TypesFeatureType,
  TypesFeatureType$outboundSchema,
} from "./types-feature-type.js";
import {
...
/** @internal */
export const TypesEntitlementFilterOrder$outboundSchema: z.ZodNativeEnum<
  typeof TypesEntitlementFilterOrder
> = z.nativeEnum(TypesEntitlementFilterOrder);
...
/** @internal */
export const TypesEntitlementFilter$outboundSchema: z.ZodType<
...
> = z.object({
  ...
  featureType: TypesFeatureType$outboundSchema.optional(),
  filters: z.array(TypesFilterCondition$outboundSchema).optional(),
  isEnabled: z.boolean().optional(),
  limit: z.number().int().optional(),
  offset: z.number().int().optional(),
  order: TypesEntitlementFilterOrder$outboundSchema.optional(),
