...
/** @internal */
export const DtoPaymentResponse$inboundSchema: z.ZodType<
  DtoPaymentResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
  amount: z.string().optional(),
  attempts: z.array(DtoPaymentAttemptResponse$inboundSchema).optional(),
