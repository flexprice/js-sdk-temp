...
/** @internal */
export const DtoSubscriptionResponse$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  latest_invoice: z.lazy(() => DtoInvoiceResponse$inboundSchema).optional(),
  line_items: z.array(SubscriptionSubscriptionLineItem$inboundSchema)
    .optional(),
