...
/** @internal */
export const GithubComFlexpriceFlexpriceInternalDomainCustomerCustomer$inboundSchema:
  z.ZodType<
...
export function githubComFlexpriceFlexpriceInternalDomainCustomerCustomerFromJSON(
  jsonString: string,
): SafeParseResult<
  GithubComFlexpriceFlexpriceInternalDomainCustomerCustomer,
  SDKValidationError
  ...
  return safeParse(
    ...
    (x) =>
      GithubComFlexpriceFlexpriceInternalDomainCustomerCustomer$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'GithubComFlexpriceFlexpriceInternalDomainCustomerCustomer' from JSON`,
  );
}
