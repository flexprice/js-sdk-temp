...
/** @internal */
export const DtoCreatePriceTier$outboundSchema: z.ZodType<
...
export function dtoCreatePriceTierToJSON(
  dtoCreatePriceTier: DtoCreatePriceTier,
): string {
  return JSON.stringify(
    DtoCreatePriceTier$outboundSchema.parse(dtoCreatePriceTier),
  );
}
