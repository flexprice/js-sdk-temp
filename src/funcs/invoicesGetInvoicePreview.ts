...
export function invoicesGetInvoicePreview(
  ...
  Result<
    models.GetInvoicePreviewResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoGetPreviewInvoiceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetInvoicePreviewResponse$inboundSchema),
    M.json(400, models.GetInvoicePreviewResponse$inboundSchema),
    M.json(500, models.GetInvoicePreviewResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
