...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateFeatureRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateFeatureResponse$inboundSchema),
    M.json(400, models.CreateFeatureResponse$inboundSchema),
    M.json(500, models.CreateFeatureResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
