...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoUpdateTenantRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateTenantResponse$inboundSchema),
    M.json([400, 404], models.UpdateTenantResponse$inboundSchema),
    M.json(500, models.UpdateTenantResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
