 ...
 */
export function invoicesPostInvoicesIdRecalculate(
...
> {
  const input: operations.PostInvoicesIdRecalculateRequest = {
    id: id,
    finalize: finalize,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PostInvoicesIdRecalculateRequest$outboundSchema.parse(value),
