...
export function subscriptionsListSubscriptionPauses(
  ...
  Result<
    operations.ListSubscriptionPausesResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSubscriptionPausesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSubscriptionPausesResponse$inboundSchema),
    M.json([400, 404], operations.ListSubscriptionPausesResponse$inboundSchema),
    M.json(500, operations.ListSubscriptionPausesResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
