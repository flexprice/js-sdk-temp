...
export function subscriptionsListSubscriptionPauses(
  ...
  Result<
    models.ListSubscriptionPausesResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.ListSubscriptionPausesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListSubscriptionPausesResponse$inboundSchema),
    M.json([400, 404], models.ListSubscriptionPausesResponse$inboundSchema),
    M.json(500, models.ListSubscriptionPausesResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
