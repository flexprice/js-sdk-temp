...
export function integrationsGetIntegration(
  ...
  Result<
    operations.GetIntegrationResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetIntegrationResponse$inboundSchema),
    M.json(404, operations.GetIntegrationResponse$inboundSchema),
    M.json(500, operations.GetIntegrationResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
