...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetIntegrationResponse$inboundSchema),
    M.json(404, models.GetIntegrationResponse$inboundSchema),
    M.json(500, models.GetIntegrationResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
