...
export function subscriptionsRemoveSubscriptionAddon(
  ...
  Result<
    models.RemoveSubscriptionAddonResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoRemoveAddonRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RemoveSubscriptionAddonResponse$inboundSchema),
    M.json(400, models.RemoveSubscriptionAddonResponse$inboundSchema),
    M.json(500, models.RemoveSubscriptionAddonResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
