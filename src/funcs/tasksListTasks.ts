...
> {
  const parsed = safeParse(
    request,
    (value) => models.ListTasksRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListTasksResponse$inboundSchema),
    M.json(400, models.ListTasksResponse$inboundSchema),
    M.json(500, models.ListTasksResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
