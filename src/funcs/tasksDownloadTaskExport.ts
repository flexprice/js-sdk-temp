...
export function tasksDownloadTaskExport(
  ...
  Result<
    models.DownloadTaskExportResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DownloadTaskExportRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DownloadTaskExportResponse$inboundSchema),
    M.json([400, 404], models.DownloadTaskExportResponse$inboundSchema),
    M.json(500, models.DownloadTaskExportResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
