...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetTaskResultRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetTaskResultResponse$inboundSchema),
    M.json([400, 404], models.GetTaskResultResponse$inboundSchema),
    M.json(500, models.GetTaskResultResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
