...
export function customersGetCustomerByExternalId(
  ...
  Result<
    models.GetCustomerByExternalIdResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.GetCustomerByExternalIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCustomerByExternalIdResponse$inboundSchema),
    M.json([400, 404], models.GetCustomerByExternalIdResponse$inboundSchema),
    M.json(500, models.GetCustomerByExternalIdResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
