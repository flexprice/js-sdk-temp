 ...
 */
export function invoicesPostInvoices(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.DtoCreateInvoiceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.DtoInvoiceResponse$inboundSchema),
