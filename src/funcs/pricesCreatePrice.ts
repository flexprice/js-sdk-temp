...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreatePriceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreatePriceResponse$inboundSchema),
    M.json(400, models.CreatePriceResponse$inboundSchema),
    M.json(500, models.CreatePriceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
