...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoCreatePriceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreatePriceResponse$inboundSchema),
    M.json(400, operations.CreatePriceResponse$inboundSchema),
    M.json(500, operations.CreatePriceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
