...
export function walletsGetCustomerWallets(
  ...
  Result<
    models.GetCustomerWalletsResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.GetCustomerWalletsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCustomerWalletsResponse$inboundSchema),
    M.json([400, 404], models.GetCustomerWalletsResponse$inboundSchema),
    M.json(500, models.GetCustomerWalletsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
