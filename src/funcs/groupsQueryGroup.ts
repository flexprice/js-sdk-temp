...
> {
  const parsed = safeParse(
    request,
    (value) => models.GroupFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryGroupResponse$inboundSchema),
    M.json(400, models.QueryGroupResponse$inboundSchema),
    M.json(500, models.QueryGroupResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
