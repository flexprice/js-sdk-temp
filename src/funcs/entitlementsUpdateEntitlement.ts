...
export function entitlementsUpdateEntitlement(
  ...
  Result<
    models.UpdateEntitlementResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateEntitlementRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateEntitlementResponse$inboundSchema),
    M.json(400, models.UpdateEntitlementResponse$inboundSchema),
    M.json(500, models.UpdateEntitlementResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
