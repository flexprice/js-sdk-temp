...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeleteAddonRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteAddonResponse$inboundSchema),
    M.json(400, models.DeleteAddonResponse$inboundSchema),
    M.json(500, models.DeleteAddonResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
