...
export function taxRatesDeleteTaxRate(
  ...
  Result<
    models.ErrorsErrorResponse | undefined,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeleteTaxRateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, models.ErrorsErrorResponse$inboundSchema.optional()),
    M.json(400, models.ErrorsErrorResponse$inboundSchema.optional()),
    M.json(500, models.ErrorsErrorResponse$inboundSchema.optional()),
  )(response, req);
  if (!result.ok) {
