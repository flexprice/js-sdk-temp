...
export function eventsIngestEventsBulk(
  ...
  Result<
    models.IngestEventsBulkResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoBulkIngestEventRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, models.IngestEventsBulkResponse$inboundSchema),
    M.json(400, models.IngestEventsBulkResponse$inboundSchema),
    M.json(500, models.IngestEventsBulkResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
