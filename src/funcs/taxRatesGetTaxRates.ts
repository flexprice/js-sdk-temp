...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetTaxRatesRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetTaxRatesResponse$inboundSchema),
    M.json(400, models.GetTaxRatesResponse$inboundSchema),
    M.json(500, models.GetTaxRatesResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
