...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateCreditNoteRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateCreditNoteResponse$inboundSchema),
    M.json([400, 401, 403, 404], models.CreateCreditNoteResponse$inboundSchema),
    M.json(500, models.CreateCreditNoteResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
