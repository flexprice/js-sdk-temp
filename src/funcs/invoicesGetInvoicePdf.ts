...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetInvoicePdfRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, models.GetInvoicePdfResponse$inboundSchema, { ctype: "*/*" }),
    M.bytes([400, 404], models.GetInvoicePdfResponse$inboundSchema, {
      ctype: "*/*",
    }),
    M.bytes(500, models.GetInvoicePdfResponse$inboundSchema, { ctype: "*/*" }),
  )(response, req);
  if (!result.ok) {
