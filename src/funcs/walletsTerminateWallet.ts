...
export function walletsTerminateWallet(
  ...
  Result<
    models.TerminateWalletResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.TerminateWalletRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TerminateWalletResponse$inboundSchema),
    M.json([400, 404], models.TerminateWalletResponse$inboundSchema),
    M.json(500, models.TerminateWalletResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
