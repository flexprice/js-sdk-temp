...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoCreateSubscriptionRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, operations.CreateSubscriptionResponse$inboundSchema),
    M.json(500, operations.CreateSubscriptionResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
