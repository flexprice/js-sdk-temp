...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateSubscriptionRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateSubscriptionResponse$inboundSchema),
    M.json(400, models.CreateSubscriptionResponse$inboundSchema),
    M.json(500, models.CreateSubscriptionResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
