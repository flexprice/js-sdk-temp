...
export function invoicesUpdateInvoicePaymentStatus(
  ...
  Result<
    models.UpdateInvoicePaymentStatusResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.UpdateInvoicePaymentStatusRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateInvoicePaymentStatusResponse$inboundSchema),
    M.json([400, 404], models.UpdateInvoicePaymentStatusResponse$inboundSchema),
    M.json(500, models.UpdateInvoicePaymentStatusResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
