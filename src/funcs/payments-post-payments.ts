 ...
 */
export function paymentsPostPayments(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.DtoCreatePaymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.DtoPaymentResponse$inboundSchema),
