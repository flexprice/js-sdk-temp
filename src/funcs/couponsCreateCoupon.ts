...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateCouponRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateCouponResponse$inboundSchema),
    M.json([400, 401, 403, 404], models.CreateCouponResponse$inboundSchema),
    M.json(500, models.CreateCouponResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
