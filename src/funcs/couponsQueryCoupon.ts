...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryCouponResponse$inboundSchema),
    M.json(400, models.QueryCouponResponse$inboundSchema),
    M.json(500, models.QueryCouponResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
