...
export function invoicesTriggerInvoiceCommsWebhook(
  ...
  Result<
    models.TriggerInvoiceCommsWebhookResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.TriggerInvoiceCommsWebhookRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TriggerInvoiceCommsWebhookResponse$inboundSchema),
    M.json([400, 404], models.TriggerInvoiceCommsWebhookResponse$inboundSchema),
    M.json(500, models.TriggerInvoiceCommsWebhookResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
