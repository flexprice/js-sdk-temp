...
export function pricesGetPriceByLookupKey(
  ...
  Result<
    models.GetPriceByLookupKeyResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetPriceByLookupKeyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetPriceByLookupKeyResponse$inboundSchema),
    M.json(400, models.GetPriceByLookupKeyResponse$inboundSchema),
    M.json(500, models.GetPriceByLookupKeyResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
