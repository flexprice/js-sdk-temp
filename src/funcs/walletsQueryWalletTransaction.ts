...
export function walletsQueryWalletTransaction(
  ...
  Result<
    models.QueryWalletTransactionResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.WalletTransactionFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryWalletTransactionResponse$inboundSchema),
    M.json(400, models.QueryWalletTransactionResponse$inboundSchema),
    M.json(500, models.QueryWalletTransactionResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
