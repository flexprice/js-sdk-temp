...
export function priceUnitsUpdatePriceUnit(
  ...
  Result<
    models.UpdatePriceUnitResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdatePriceUnitRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdatePriceUnitResponse$inboundSchema),
    M.json([400, 404], models.UpdatePriceUnitResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
