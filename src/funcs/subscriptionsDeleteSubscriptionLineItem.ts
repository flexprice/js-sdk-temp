...
export function subscriptionsDeleteSubscriptionLineItem(
  ...
  Result<
    models.DeleteSubscriptionLineItemResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.DeleteSubscriptionLineItemRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteSubscriptionLineItemResponse$inboundSchema),
    M.json(400, models.DeleteSubscriptionLineItemResponse$inboundSchema),
    M.json(500, models.DeleteSubscriptionLineItemResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
