 ...
 */
export function webhooksPostWebhooksStripeTenantIdEnvironmentId(
...
> {
  const input: operations.PostWebhooksStripeTenantIdEnvironmentIdRequest = {
    tenantId: tenantId,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PostWebhooksStripeTenantIdEnvironmentIdRequest$outboundSchema
        .parse(value),
