...
> {
  const parsed = safeParse(
    request,
    (value) => models.CostsheetFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryCostsheetResponse$inboundSchema),
    M.json(400, models.QueryCostsheetResponse$inboundSchema),
    M.json(500, models.QueryCostsheetResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
