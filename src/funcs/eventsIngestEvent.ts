...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoIngestEventRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, models.IngestEventResponse$inboundSchema),
    M.json(400, models.IngestEventResponse$inboundSchema),
    M.json(500, models.IngestEventResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
