...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoIngestEventRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.IngestEventResponse$inboundSchema),
    M.json(400, operations.IngestEventResponse$inboundSchema),
    M.json(500, operations.IngestEventResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
