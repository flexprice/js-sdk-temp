...
> {
  const parsed = safeParse(
    request,
    (value) => models.AlertLogFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryAlertLogResponse$inboundSchema),
    M.json(400, models.QueryAlertLogResponse$inboundSchema),
    M.json(500, models.QueryAlertLogResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
