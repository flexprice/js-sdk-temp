...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetSubscriptionRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetSubscriptionResponse$inboundSchema),
    M.json(400, models.GetSubscriptionResponse$inboundSchema),
    M.json(500, models.GetSubscriptionResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
