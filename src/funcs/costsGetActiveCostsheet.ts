...
export function costsGetActiveCostsheet(
  ...
  Result<
    models.GetActiveCostsheetResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetActiveCostsheetResponse$inboundSchema),
    M.json(404, models.GetActiveCostsheetResponse$inboundSchema),
    M.json(500, models.GetActiveCostsheetResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
