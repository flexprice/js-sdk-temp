...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetEventRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetEventResponse$inboundSchema),
    M.json(404, models.GetEventResponse$inboundSchema),
    M.json(500, models.GetEventResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
