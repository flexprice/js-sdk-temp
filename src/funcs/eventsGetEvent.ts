...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetEventResponse$inboundSchema),
    M.json(404, operations.GetEventResponse$inboundSchema),
    M.json(500, operations.GetEventResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
