...
export function walletsGetWalletsByCustomerId(
  ...
  Result<
    models.GetWalletsByCustomerIdResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetWalletsByCustomerIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetWalletsByCustomerIdResponse$inboundSchema),
    M.json(400, models.GetWalletsByCustomerIdResponse$inboundSchema),
    M.json(500, models.GetWalletsByCustomerIdResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
