...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetUserInfoResponse$inboundSchema),
    M.json(401, models.GetUserInfoResponse$inboundSchema),
    M.json(500, models.GetUserInfoResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
