...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPriceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPriceResponse$inboundSchema),
    M.json(400, operations.GetPriceResponse$inboundSchema),
    M.json(500, operations.GetPriceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
