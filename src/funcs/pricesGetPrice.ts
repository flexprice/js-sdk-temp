...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetPriceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetPriceResponse$inboundSchema),
    M.json(400, models.GetPriceResponse$inboundSchema),
    M.json(500, models.GetPriceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
