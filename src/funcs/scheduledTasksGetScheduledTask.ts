...
export function scheduledTasksGetScheduledTask(
  ...
  Result<
    models.GetScheduledTaskResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetScheduledTaskRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetScheduledTaskResponse$inboundSchema),
    M.json([400, 404], models.GetScheduledTaskResponse$inboundSchema),
    M.json(500, models.GetScheduledTaskResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
