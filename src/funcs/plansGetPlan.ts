...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPlanResponse$inboundSchema),
    M.json([400, 404], operations.GetPlanResponse$inboundSchema),
    M.json(500, operations.GetPlanResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
