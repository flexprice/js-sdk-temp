...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetPlanRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json([400, 404], models.GetPlanResponse$inboundSchema),
    M.json(500, models.GetPlanResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
