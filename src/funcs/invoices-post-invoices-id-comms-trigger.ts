 ...
 */
export function invoicesPostInvoicesIdCommsTrigger(
...
> {
  const input: operations.PostInvoicesIdCommsTriggerRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PostInvoicesIdCommsTriggerRequest$outboundSchema.parse(value),
