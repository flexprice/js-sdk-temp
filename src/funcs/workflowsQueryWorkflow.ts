...
> {
  const parsed = safeParse(
    request,
    (value) => models.WorkflowExecutionFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryWorkflowResponse$inboundSchema),
    M.json(400, models.QueryWorkflowResponse$inboundSchema),
    M.json(500, models.QueryWorkflowResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
