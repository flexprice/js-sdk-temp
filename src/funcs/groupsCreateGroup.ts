...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateGroupRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateGroupResponse$inboundSchema),
    M.json(400, models.CreateGroupResponse$inboundSchema),
    M.json(500, models.CreateGroupResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
