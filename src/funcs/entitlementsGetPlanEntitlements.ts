...
export function entitlementsGetPlanEntitlements(
  ...
  Result<
    models.GetPlanEntitlementsResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetPlanEntitlementsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetPlanEntitlementsResponse$inboundSchema),
    M.json([400, 404], models.GetPlanEntitlementsResponse$inboundSchema),
    M.json(500, models.GetPlanEntitlementsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
