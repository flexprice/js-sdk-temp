...
export function subscriptionsPostV1SubscriptionsSchedulesScheduleIdCancel(
  ...
  Result<
    components.DtoCancelScheduleResponse,
    | FlexPriceError
...
> {
  const input: operations.PostV1SubscriptionsSchedulesScheduleIdCancelRequest =
    {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.DtoCancelScheduleResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
