...
export function webhooksHandleChargebeeWebhook(
  ...
  Result<
    models.HandleChargebeeWebhookResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.HandleChargebeeWebhookRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.HandleChargebeeWebhookResponse$inboundSchema),
    M.json(400, models.HandleChargebeeWebhookResponse$inboundSchema),
    M.json(401, models.HandleChargebeeWebhookResponse$inboundSchema),
    M.json(500, models.HandleChargebeeWebhookResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
