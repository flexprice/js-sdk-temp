...
export function customersGetCustomerEntitlements(
  ...
  Result<
    models.GetCustomerEntitlementsResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.GetCustomerEntitlementsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCustomerEntitlementsResponse$inboundSchema),
    M.json(400, models.GetCustomerEntitlementsResponse$inboundSchema),
    M.json(500, models.GetCustomerEntitlementsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
