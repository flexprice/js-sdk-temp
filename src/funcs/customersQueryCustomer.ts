...
> {
  const parsed = safeParse(
    request,
    (value) => models.CustomerFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryCustomerResponse$inboundSchema),
    M.json(400, models.QueryCustomerResponse$inboundSchema),
    M.json(500, models.QueryCustomerResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
