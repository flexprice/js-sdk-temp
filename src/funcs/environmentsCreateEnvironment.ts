...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateEnvironmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateEnvironmentResponse$inboundSchema),
    M.json(400, models.CreateEnvironmentResponse$inboundSchema),
    M.json(500, models.CreateEnvironmentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
