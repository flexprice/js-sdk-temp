...
export function webhooksHandleNomodWebhook(
  ...
  Result<
    models.HandleNomodWebhookResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.HandleNomodWebhookRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.HandleNomodWebhookResponse$inboundSchema),
    M.json(401, models.HandleNomodWebhookResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
