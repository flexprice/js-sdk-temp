...
export function invoicesRecalculateInvoice(
  ...
  Result<
    models.RecalculateInvoiceResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.RecalculateInvoiceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RecalculateInvoiceResponse$inboundSchema),
    M.json([400, 404], models.RecalculateInvoiceResponse$inboundSchema),
    M.json(500, models.RecalculateInvoiceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
