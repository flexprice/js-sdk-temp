...
export function subscriptionsPreviewSubscriptionChange(
  ...
  Result<
    models.PreviewSubscriptionChangeResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.PreviewSubscriptionChangeRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PreviewSubscriptionChangeResponse$inboundSchema),
    M.json([400, 404], models.PreviewSubscriptionChangeResponse$inboundSchema),
    M.json(500, models.PreviewSubscriptionChangeResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
