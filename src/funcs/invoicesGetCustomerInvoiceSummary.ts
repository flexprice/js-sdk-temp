...
export function invoicesGetCustomerInvoiceSummary(
  ...
  Result<
    models.GetCustomerInvoiceSummaryResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.GetCustomerInvoiceSummaryRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCustomerInvoiceSummaryResponse$inboundSchema),
    M.json(400, models.GetCustomerInvoiceSummaryResponse$inboundSchema),
    M.json(500, models.GetCustomerInvoiceSummaryResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
