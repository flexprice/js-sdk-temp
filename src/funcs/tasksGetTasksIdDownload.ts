 ...
 */
export function tasksGetTasksIdDownload(
...
> {
  const input: operations.GetTasksIdDownloadRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => operations.GetTasksIdDownloadRequest$outboundSchema.parse(value),
