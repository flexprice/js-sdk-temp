...
> {
  const parsed = safeParse(
    request,
    (value) => models.InvoiceFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryInvoiceResponse$inboundSchema),
    M.json(400, models.QueryInvoiceResponse$inboundSchema),
    M.json(500, models.QueryInvoiceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
