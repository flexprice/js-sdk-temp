...
export function invoicesQueryInvoice(
  ...
  Result<
    operations.QueryInvoiceResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.QueryInvoiceResponse$inboundSchema),
    M.json(400, operations.QueryInvoiceResponse$inboundSchema),
    M.json(500, operations.QueryInvoiceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
