...
> {
  const parsed = safeParse(
    request,
    (value) => models.PlanFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryPlanResponse$inboundSchema),
    M.json(400, models.QueryPlanResponse$inboundSchema),
    M.json(500, models.QueryPlanResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
