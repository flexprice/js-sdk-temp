...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.QueryPlanResponse$inboundSchema),
    M.json(400, operations.QueryPlanResponse$inboundSchema),
    M.json(500, operations.QueryPlanResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
