...
> {
  const parsed = safeParse(
    request,
    (value) => models.SyncPlanPricesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SyncPlanPricesResponse$inboundSchema),
    M.json([400, 404, 422], models.SyncPlanPricesResponse$inboundSchema),
    M.json(500, models.SyncPlanPricesResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
