...
export function entityIntegrationMappingsCreateEntityIntegrationMapping(
  ...
  Result<
    operations.CreateEntityIntegrationMappingResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.DtoCreateEntityIntegrationMappingRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      201,
      operations.CreateEntityIntegrationMappingResponse$inboundSchema,
    ),
    M.json(
      [400, 401, 409],
      operations.CreateEntityIntegrationMappingResponse$inboundSchema,
