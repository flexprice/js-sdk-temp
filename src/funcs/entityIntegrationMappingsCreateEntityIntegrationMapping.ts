 ...
 */
export function entityIntegrationMappingsCreateEntityIntegrationMapping(
  client: FlexpriceCore,
  request: models.DtoCreateEntityIntegrationMappingRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.CreateEntityIntegrationMappingResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.DtoCreateEntityIntegrationMappingRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateEntityIntegrationMappingResponse$inboundSchema),
    M.json(
      [400, 401, 409],
      models.CreateEntityIntegrationMappingResponse$inboundSchema,
    ),
    M.json(500, models.CreateEntityIntegrationMappingResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
