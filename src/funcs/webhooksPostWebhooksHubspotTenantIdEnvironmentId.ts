 ...
 */
export function webhooksPostWebhooksHubspotTenantIdEnvironmentId(
...
> {
  const input: operations.PostWebhooksHubspotTenantIdEnvironmentIdRequest = {
    tenantId: tenantId,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PostWebhooksHubspotTenantIdEnvironmentIdRequest$outboundSchema
        .parse(value),
