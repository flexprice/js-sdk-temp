...
export function eventsGetUsageByMeter(
  ...
  Result<
    models.GetUsageByMeterResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoGetUsageByMeterRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetUsageByMeterResponse$inboundSchema),
    M.json([400, 404], models.GetUsageByMeterResponse$inboundSchema),
    M.json(500, models.GetUsageByMeterResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
