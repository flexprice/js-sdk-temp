...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.ListScheduledTasksRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListScheduledTasksResponse$inboundSchema),
    M.json(400, models.ListScheduledTasksResponse$inboundSchema),
    M.json(500, models.ListScheduledTasksResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
