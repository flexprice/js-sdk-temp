...
export function webhooksHandleQuickbooksWebhook(
  ...
  Result<
    models.HandleQuickbooksWebhookResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.HandleQuickbooksWebhookRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.HandleQuickbooksWebhookResponse$inboundSchema),
    M.json(400, models.HandleQuickbooksWebhookResponse$inboundSchema),
    M.json(401, models.HandleQuickbooksWebhookResponse$inboundSchema),
    M.json(500, models.HandleQuickbooksWebhookResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
