...
> {
  const parsed = safeParse(
    request,
    (value) => models.FinalizeInvoiceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.FinalizeInvoiceResponse$inboundSchema),
    M.json(400, models.FinalizeInvoiceResponse$inboundSchema),
    M.json(500, models.FinalizeInvoiceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
