...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeletePlanRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json([400, 404], models.DeletePlanResponse$inboundSchema),
    M.json(500, models.DeletePlanResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
