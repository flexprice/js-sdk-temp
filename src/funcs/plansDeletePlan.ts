...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeletePlanResponse$inboundSchema),
    M.json([400, 404], operations.DeletePlanResponse$inboundSchema),
    M.json(500, operations.DeletePlanResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
