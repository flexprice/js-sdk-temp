 ...
 */
export function customersGetCustomer(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetCustomerRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, models.GetCustomerResponse$inboundSchema),
    M.json(500, models.GetCustomerResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
