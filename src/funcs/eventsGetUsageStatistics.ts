...
export function eventsGetUsageStatistics(
  ...
  Result<
    models.GetUsageStatisticsResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoGetUsageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetUsageStatisticsResponse$inboundSchema),
    M.json(400, models.GetUsageStatisticsResponse$inboundSchema),
    M.json(500, models.GetUsageStatisticsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
