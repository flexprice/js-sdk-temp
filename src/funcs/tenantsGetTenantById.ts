...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetTenantByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetTenantByIdResponse$inboundSchema),
    M.json(404, models.GetTenantByIdResponse$inboundSchema),
    M.json(500, models.GetTenantByIdResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
