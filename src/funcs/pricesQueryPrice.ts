...
> {
  const parsed = safeParse(
    request,
    (value) => models.PriceFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryPriceResponse$inboundSchema),
    M.json(400, models.QueryPriceResponse$inboundSchema),
    M.json(500, models.QueryPriceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
