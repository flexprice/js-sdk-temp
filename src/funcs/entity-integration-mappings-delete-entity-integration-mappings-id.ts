 ...
 */
export function entityIntegrationMappingsDeleteEntityIntegrationMappingsId(
...
> {
  const input: operations.DeleteEntityIntegrationMappingsIdRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeleteEntityIntegrationMappingsIdRequest$outboundSchema.parse(
        value,
      ),
