...
export function walletsQueryWallet(
  ...
  Result<
    operations.QueryWalletResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.QueryWalletResponse$inboundSchema),
    M.json(400, operations.QueryWalletResponse$inboundSchema),
    M.json(500, operations.QueryWalletResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
