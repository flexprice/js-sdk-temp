...
> {
  const parsed = safeParse(
    request,
    (value) => models.WalletFilter$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/wallets/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryWalletResponse$inboundSchema),
    M.json(400, models.QueryWalletResponse$inboundSchema),
    M.json(500, models.QueryWalletResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
