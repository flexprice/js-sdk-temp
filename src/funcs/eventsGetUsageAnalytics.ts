...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoGetUsageAnalyticsRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, models.GetUsageAnalyticsResponse$inboundSchema),
    M.json(500, models.GetUsageAnalyticsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
