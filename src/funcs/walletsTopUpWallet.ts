...
> {
  const parsed = safeParse(
    request,
    (value) => models.TopUpWalletRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TopUpWalletResponse$inboundSchema),
    M.json([400, 404], models.TopUpWalletResponse$inboundSchema),
    M.json(500, models.TopUpWalletResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
