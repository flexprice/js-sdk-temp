...
export function subscriptionsExecuteSubscriptionChange(
  ...
  Result<
    models.ExecuteSubscriptionChangeResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.ExecuteSubscriptionChangeRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ExecuteSubscriptionChangeResponse$inboundSchema),
    M.json([400, 404], models.ExecuteSubscriptionChangeResponse$inboundSchema),
    M.json(500, models.ExecuteSubscriptionChangeResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
