...
export function walletsGetWalletBalance(
  ...
  Result<
    models.GetWalletBalanceResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetWalletBalanceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetWalletBalanceResponse$inboundSchema),
    M.json([400, 404], models.GetWalletBalanceResponse$inboundSchema),
    M.json(500, models.GetWalletBalanceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
