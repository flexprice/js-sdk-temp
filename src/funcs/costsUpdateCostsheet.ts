...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateCostsheetRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json([400, 404, 409], models.UpdateCostsheetResponse$inboundSchema),
    M.json(500, models.UpdateCostsheetResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
