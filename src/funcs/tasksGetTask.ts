...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetTaskRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetTaskResponse$inboundSchema),
    M.json([400, 404], models.GetTaskResponse$inboundSchema),
    M.json(500, models.GetTaskResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
