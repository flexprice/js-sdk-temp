...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetTaskResponse$inboundSchema),
    M.json([400, 404], operations.GetTaskResponse$inboundSchema),
    M.json(500, operations.GetTaskResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
