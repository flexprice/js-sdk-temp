...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateTaskStatusRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateTaskStatusResponse$inboundSchema),
    M.json([400, 404], models.UpdateTaskStatusResponse$inboundSchema),
    M.json(500, models.UpdateTaskStatusResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
