...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetRbacRoleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetRbacRoleResponse$inboundSchema),
    M.json(404, models.GetRbacRoleResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
