...
export function tenantsGetTenantBillingUsage(
  ...
  Result<
    models.GetTenantBillingUsageResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetTenantBillingUsageResponse$inboundSchema),
    M.json([400, 404], models.GetTenantBillingUsageResponse$inboundSchema),
    M.json(500, models.GetTenantBillingUsageResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
