...
export function entitlementsGetAddonEntitlements(
  ...
  Result<
    models.GetAddonEntitlementsResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetAddonEntitlementsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetAddonEntitlementsResponse$inboundSchema),
    M.json([400, 404], models.GetAddonEntitlementsResponse$inboundSchema),
    M.json(500, models.GetAddonEntitlementsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
