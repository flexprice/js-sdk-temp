...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetPaymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetPaymentResponse$inboundSchema),
    M.json([400, 404], models.GetPaymentResponse$inboundSchema),
    M.json(500, models.GetPaymentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
