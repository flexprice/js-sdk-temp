...
export function customersGetCustomerUsageSummary(
  ...
  Result<
    models.GetCustomerUsageSummaryResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.GetCustomerUsageSummaryRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCustomerUsageSummaryResponse$inboundSchema),
    M.json(400, models.GetCustomerUsageSummaryResponse$inboundSchema),
    M.json(500, models.GetCustomerUsageSummaryResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
