 ...
 */
export function customerDashboardGetCustomerDashboardExternalId(
...
> {
  const path = pathToFunc("/customer-dashboard/:external_id")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.DtoDashboardSessionResponse$inboundSchema),
