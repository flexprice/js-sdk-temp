...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreatePriceUnitRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreatePriceUnitResponse$inboundSchema),
    M.json(400, models.CreatePriceUnitResponse$inboundSchema),
    M.json(500, models.CreatePriceUnitResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
