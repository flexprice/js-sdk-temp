...
export function creditNotesProcessCreditNote(
  ...
  Result<
    models.ProcessCreditNoteResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.ProcessCreditNoteRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProcessCreditNoteResponse$inboundSchema),
    M.json(
      [400, 401, 403, 404],
      models.ProcessCreditNoteResponse$inboundSchema,
    ),
    M.json(500, models.ProcessCreditNoteResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
