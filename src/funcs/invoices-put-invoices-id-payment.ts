 ...
 */
export function invoicesPutInvoicesIdPayment(
...
> {
  const input: operations.PutInvoicesIdPaymentRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PutInvoicesIdPaymentRequest$outboundSchema.parse(value),
