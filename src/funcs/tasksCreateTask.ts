...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateTaskRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, models.CreateTaskResponse$inboundSchema),
    M.json(400, models.CreateTaskResponse$inboundSchema),
    M.json(500, models.CreateTaskResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
