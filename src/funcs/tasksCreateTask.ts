...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoCreateTaskRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.CreateTaskResponse$inboundSchema),
    M.json(400, operations.CreateTaskResponse$inboundSchema),
    M.json(500, operations.CreateTaskResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
