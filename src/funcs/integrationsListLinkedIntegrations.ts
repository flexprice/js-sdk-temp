...
export function integrationsListLinkedIntegrations(
  ...
  Result<
    models.ListLinkedIntegrationsResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListLinkedIntegrationsResponse$inboundSchema),
    M.json(500, models.ListLinkedIntegrationsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
