...
export function integrationsListLinkedIntegrations(
  ...
  Result<
    operations.ListLinkedIntegrationsResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListLinkedIntegrationsResponse$inboundSchema),
    M.json(500, operations.ListLinkedIntegrationsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
