...
export function creditGrantsGetPlanCreditGrants(
  ...
  Result<
    models.GetPlanCreditGrantsResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetPlanCreditGrantsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetPlanCreditGrantsResponse$inboundSchema),
    M.json([400, 404], models.GetPlanCreditGrantsResponse$inboundSchema),
    M.json(500, models.GetPlanCreditGrantsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
