...
export function eventsGetHuggingfaceInferenceData(
  ...
  Result<
    models.GetHuggingfaceInferenceDataResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetHuggingfaceInferenceDataResponse$inboundSchema),
    M.json(500, models.GetHuggingfaceInferenceDataResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
