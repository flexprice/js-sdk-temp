...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateTaxRateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateTaxRateResponse$inboundSchema),
    M.json(400, models.UpdateTaxRateResponse$inboundSchema),
    M.json(500, models.UpdateTaxRateResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
