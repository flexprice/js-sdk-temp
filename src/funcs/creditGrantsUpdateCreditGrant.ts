...
export function creditGrantsUpdateCreditGrant(
  ...
  Result<
    models.UpdateCreditGrantResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateCreditGrantRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateCreditGrantResponse$inboundSchema),
    M.json(400, models.UpdateCreditGrantResponse$inboundSchema),
    M.json(500, models.UpdateCreditGrantResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
