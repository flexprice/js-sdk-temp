...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetCreditGrantRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCreditGrantResponse$inboundSchema),
    M.json(400, models.GetCreditGrantResponse$inboundSchema),
    M.json(500, models.GetCreditGrantResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
