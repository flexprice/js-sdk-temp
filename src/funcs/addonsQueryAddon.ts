...
> {
  const parsed = safeParse(
    request,
    (value) => models.AddonFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryAddonResponse$inboundSchema),
    M.json(400, models.QueryAddonResponse$inboundSchema),
    M.json(500, models.QueryAddonResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
