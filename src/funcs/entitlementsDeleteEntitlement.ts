...
export function entitlementsDeleteEntitlement(
  ...
  Result<
    models.DeleteEntitlementResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeleteEntitlementRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteEntitlementResponse$inboundSchema),
    M.json(400, models.DeleteEntitlementResponse$inboundSchema),
    M.json(500, models.DeleteEntitlementResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
