...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeleteFeatureRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteFeatureResponse$inboundSchema),
    M.json([400, 404], models.DeleteFeatureResponse$inboundSchema),
    M.json(500, models.DeleteFeatureResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
