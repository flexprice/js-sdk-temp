...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateUserRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateUserResponse$inboundSchema),
    M.json(400, models.CreateUserResponse$inboundSchema),
    M.json(500, models.CreateUserResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
