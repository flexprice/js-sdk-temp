...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoCreateUserRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, operations.CreateUserResponse$inboundSchema),
    M.json(500, operations.CreateUserResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
