...
> {
  const parsed = safeParse(
    request,
    (value) => models.PriceUnitFilter$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryPriceUnitResponse$inboundSchema),
    M.json(400, models.QueryPriceUnitResponse$inboundSchema),
    M.json(500, models.QueryPriceUnitResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
