...
export function subscriptionsUpdateSubscriptionLineItem(
  ...
  Result<
    models.UpdateSubscriptionLineItemResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.UpdateSubscriptionLineItemRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateSubscriptionLineItemResponse$inboundSchema),
    M.json(400, models.UpdateSubscriptionLineItemResponse$inboundSchema),
    M.json(500, models.UpdateSubscriptionLineItemResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
