...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateAddonRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateAddonResponse$inboundSchema),
    M.json(400, models.UpdateAddonResponse$inboundSchema),
    M.json(500, models.UpdateAddonResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
