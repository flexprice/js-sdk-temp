...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdatePlanRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json([400, 404], models.UpdatePlanResponse$inboundSchema),
    M.json(500, models.UpdatePlanResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
