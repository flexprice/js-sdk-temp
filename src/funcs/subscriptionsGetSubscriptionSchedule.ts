...
export function subscriptionsGetSubscriptionSchedule(
  ...
  Result<
    shared.DtoSubscriptionScheduleResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSubscriptionScheduleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.DtoSubscriptionScheduleResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
