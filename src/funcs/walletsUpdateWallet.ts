...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateWalletResponse$inboundSchema),
    M.json([400, 404], operations.UpdateWalletResponse$inboundSchema),
    M.json(500, operations.UpdateWalletResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
