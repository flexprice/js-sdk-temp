 ...
 */
export function walletsGetCustomersWallets(
...
> {
  const input: operations.GetCustomersWalletsRequest = {
    id: id,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetCustomersWalletsRequest$outboundSchema.parse(value),
