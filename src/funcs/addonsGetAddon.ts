...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetAddonRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetAddonResponse$inboundSchema),
    M.json(400, models.GetAddonResponse$inboundSchema),
    M.json(500, models.GetAddonResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
