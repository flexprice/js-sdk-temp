...
export function priceUnitsGetPriceUnitByCode(
  ...
  Result<
    models.GetPriceUnitByCodeResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetPriceUnitByCodeRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetPriceUnitByCodeResponse$inboundSchema),
    M.json([400, 404], models.GetPriceUnitByCodeResponse$inboundSchema),
    M.json(500, models.GetPriceUnitByCodeResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
