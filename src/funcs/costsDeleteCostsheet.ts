...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeleteCostsheetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteCostsheetResponse$inboundSchema),
    M.json([400, 404], models.DeleteCostsheetResponse$inboundSchema),
    M.json(500, models.DeleteCostsheetResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
