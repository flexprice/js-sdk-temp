...
export function costsGetDetailedCostAnalyticsV2(
  ...
  Result<
    models.GetDetailedCostAnalyticsV2Response,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoGetCostAnalyticsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetDetailedCostAnalyticsV2Response$inboundSchema),
    M.json(400, models.GetDetailedCostAnalyticsV2Response$inboundSchema),
    M.json(500, models.GetDetailedCostAnalyticsV2Response$inboundSchema),
  )(response, req);
  if (!result.ok) {
