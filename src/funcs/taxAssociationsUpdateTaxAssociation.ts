...
export function taxAssociationsUpdateTaxAssociation(
  ...
  Result<
    models.UpdateTaxAssociationResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateTaxAssociationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateTaxAssociationResponse$inboundSchema),
    M.json(400, models.UpdateTaxAssociationResponse$inboundSchema),
    M.json(500, models.UpdateTaxAssociationResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
