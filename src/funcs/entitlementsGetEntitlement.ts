...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetEntitlementRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetEntitlementResponse$inboundSchema),
    M.json(400, models.GetEntitlementResponse$inboundSchema),
    M.json(500, models.GetEntitlementResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
