...
export function entitlementsCreateEntitlement(
  ...
  Result<
    models.CreateEntitlementResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateEntitlementRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateEntitlementResponse$inboundSchema),
    M.json(400, models.CreateEntitlementResponse$inboundSchema),
    M.json(500, models.CreateEntitlementResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
