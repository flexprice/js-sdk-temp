...
export function creditGrantsCreateCreditGrant(
  ...
  Result<
    models.CreateCreditGrantResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateCreditGrantRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateCreditGrantResponse$inboundSchema),
    M.json(400, models.CreateCreditGrantResponse$inboundSchema),
    M.json(500, models.CreateCreditGrantResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
