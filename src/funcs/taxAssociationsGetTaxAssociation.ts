...
export function taxAssociationsGetTaxAssociation(
  ...
  Result<
    models.GetTaxAssociationResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetTaxAssociationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetTaxAssociationResponse$inboundSchema),
    M.json(400, models.GetTaxAssociationResponse$inboundSchema),
    M.json(500, models.GetTaxAssociationResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
