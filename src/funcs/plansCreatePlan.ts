...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoCreatePlanRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreatePlanResponse$inboundSchema),
    M.json(400, operations.CreatePlanResponse$inboundSchema),
    M.json(500, operations.CreatePlanResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
