...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreatePlanRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreatePlanResponse$inboundSchema),
    M.json(400, models.CreatePlanResponse$inboundSchema),
    M.json(500, models.CreatePlanResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
