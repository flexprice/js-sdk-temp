...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetCostsheetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCostsheetResponse$inboundSchema),
    M.json([400, 404], models.GetCostsheetResponse$inboundSchema),
    M.json(500, models.GetCostsheetResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
