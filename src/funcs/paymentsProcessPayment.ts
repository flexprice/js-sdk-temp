...
> {
  const parsed = safeParse(
    request,
    (value) => models.ProcessPaymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProcessPaymentResponse$inboundSchema),
    M.json([400, 404], models.ProcessPaymentResponse$inboundSchema),
    M.json(500, models.ProcessPaymentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
