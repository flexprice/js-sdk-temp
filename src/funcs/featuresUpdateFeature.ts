...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateFeatureRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json([400, 404], models.UpdateFeatureResponse$inboundSchema),
    M.json(500, models.UpdateFeatureResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
