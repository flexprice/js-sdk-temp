...
export function plansPostPlansIdClone(
  ...
  Result<
    models.PostPlansIdCloneResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.PostPlansIdCloneRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.PostPlansIdCloneResponse$inboundSchema),
    M.json([400, 404, 409], models.PostPlansIdCloneResponse$inboundSchema),
    M.json(500, models.PostPlansIdCloneResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
