...
export function priceUnitsDeletePriceUnit(
  ...
  Result<
    models.DeletePriceUnitResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeletePriceUnitRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeletePriceUnitResponse$inboundSchema),
    M.json([400, 404], models.DeletePriceUnitResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
