...
export function subscriptionsQuerySubscription(
  ...
  Result<
    operations.QuerySubscriptionResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.QuerySubscriptionResponse$inboundSchema),
    M.json(400, operations.QuerySubscriptionResponse$inboundSchema),
    M.json(500, operations.QuerySubscriptionResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
