...
export function subscriptionsQuerySubscription(
  ...
  Result<
    models.QuerySubscriptionResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.SubscriptionFilter$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/subscriptions/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QuerySubscriptionResponse$inboundSchema),
    M.json(400, models.QuerySubscriptionResponse$inboundSchema),
    M.json(500, models.QuerySubscriptionResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
