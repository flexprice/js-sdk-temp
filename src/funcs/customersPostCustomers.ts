 ...
 * Create a customer
 */
export function customersPostCustomers(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.DtoCreateCustomerRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.DtoCustomerResponse$inboundSchema),
