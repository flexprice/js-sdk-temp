...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateCustomerRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["dto.UpdateCustomerRequest"], {
    explode: true,
  });
  ...
  >(
    ...
    M.json(400, models.UpdateCustomerResponse$inboundSchema),
    M.json(500, models.UpdateCustomerResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
