...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoCreateWalletRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, operations.CreateWalletResponse$inboundSchema),
    M.json(500, operations.CreateWalletResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
