 ...
 */
export function walletsCreateWallet(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateWalletRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateWalletResponse$inboundSchema),
    M.json(400, models.CreateWalletResponse$inboundSchema),
    M.json(500, models.CreateWalletResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
