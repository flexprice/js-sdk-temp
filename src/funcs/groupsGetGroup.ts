...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetGroupRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetGroupResponse$inboundSchema),
    M.json([400, 404], models.GetGroupResponse$inboundSchema),
    M.json(500, models.GetGroupResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
