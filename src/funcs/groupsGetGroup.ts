...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetGroupResponse$inboundSchema),
    M.json([400, 404], operations.GetGroupResponse$inboundSchema),
    M.json(500, operations.GetGroupResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
