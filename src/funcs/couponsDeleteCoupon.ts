...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeleteCouponRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteCouponResponse$inboundSchema),
    M.json([400, 401, 403, 404], models.DeleteCouponResponse$inboundSchema),
    M.json(500, models.DeleteCouponResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
