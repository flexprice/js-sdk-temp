...
export function environmentsUpdateEnvironment(
  ...
  Result<
    operations.UpdateEnvironmentResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateEnvironmentResponse$inboundSchema),
    M.json([400, 404], operations.UpdateEnvironmentResponse$inboundSchema),
    M.json(500, operations.UpdateEnvironmentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
