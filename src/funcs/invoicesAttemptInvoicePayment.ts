...
export function invoicesAttemptInvoicePayment(
  ...
  Result<
    models.AttemptInvoicePaymentResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.AttemptInvoicePaymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AttemptInvoicePaymentResponse$inboundSchema),
    M.json([400, 404], models.AttemptInvoicePaymentResponse$inboundSchema),
    M.json(500, models.AttemptInvoicePaymentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
