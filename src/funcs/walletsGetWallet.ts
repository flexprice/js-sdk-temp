...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetWalletRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetWalletResponse$inboundSchema),
    M.json([400, 404], models.GetWalletResponse$inboundSchema),
    M.json(500, models.GetWalletResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
