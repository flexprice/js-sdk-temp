...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateAPIKeyRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, models.CreateApiKeyResponse$inboundSchema),
    M.json(500, models.CreateApiKeyResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
