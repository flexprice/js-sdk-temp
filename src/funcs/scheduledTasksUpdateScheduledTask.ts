...
export function scheduledTasksUpdateScheduledTask(
  ...
  Result<
    models.UpdateScheduledTaskResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateScheduledTaskRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateScheduledTaskResponse$inboundSchema),
    M.json([400, 404], models.UpdateScheduledTaskResponse$inboundSchema),
    M.json(500, models.UpdateScheduledTaskResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
