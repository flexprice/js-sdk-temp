...
export function creditGrantsDeleteCreditGrant(
  ...
  Result<
    models.DeleteCreditGrantResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeleteCreditGrantRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteCreditGrantResponse$inboundSchema),
    M.json(400, models.DeleteCreditGrantResponse$inboundSchema),
    M.json(500, models.DeleteCreditGrantResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
