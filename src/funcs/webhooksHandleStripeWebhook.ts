...
export function webhooksHandleStripeWebhook(
  ...
  Result<
    models.HandleStripeWebhookResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.HandleStripeWebhookRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.HandleStripeWebhookResponse$inboundSchema),
    M.json(400, models.HandleStripeWebhookResponse$inboundSchema),
    M.json(500, models.HandleStripeWebhookResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
