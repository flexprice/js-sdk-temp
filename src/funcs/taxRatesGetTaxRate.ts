...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetTaxRateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetTaxRateResponse$inboundSchema),
    M.json(400, models.GetTaxRateResponse$inboundSchema),
    M.json(500, models.GetTaxRateResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
