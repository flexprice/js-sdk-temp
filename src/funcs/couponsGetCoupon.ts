...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetCouponRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCouponResponse$inboundSchema),
    M.json([400, 404], models.GetCouponResponse$inboundSchema),
    M.json(500, models.GetCouponResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
