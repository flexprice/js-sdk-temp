...
export function integrationsCreateOrUpdateIntegration(
  ...
  Result<
    models.CreateOrUpdateIntegrationResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.CreateOrUpdateIntegrationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateOrUpdateIntegrationResponse$inboundSchema),
    M.json(400, models.CreateOrUpdateIntegrationResponse$inboundSchema),
    M.json(500, models.CreateOrUpdateIntegrationResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
