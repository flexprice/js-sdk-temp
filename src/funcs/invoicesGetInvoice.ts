...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetInvoiceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetInvoiceResponse$inboundSchema),
    M.json(404, models.GetInvoiceResponse$inboundSchema),
    M.json(500, models.GetInvoiceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
