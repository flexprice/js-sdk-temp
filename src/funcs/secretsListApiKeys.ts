...
> {
  const parsed = safeParse(
    request,
    (value) => models.ListApiKeysRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListApiKeysResponse$inboundSchema),
    M.json(400, models.ListApiKeysResponse$inboundSchema),
    M.json(500, models.ListApiKeysResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
