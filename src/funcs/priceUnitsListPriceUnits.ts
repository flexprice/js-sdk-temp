...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.ListPriceUnitsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListPriceUnitsResponse$inboundSchema),
    M.json(400, models.ListPriceUnitsResponse$inboundSchema),
    M.json(500, models.ListPriceUnitsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
