...
export function taxAssociationsDeleteTaxAssociation(
  ...
  Result<
    models.DeleteTaxAssociationResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeleteTaxAssociationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteTaxAssociationResponse$inboundSchema),
    M.json(400, models.DeleteTaxAssociationResponse$inboundSchema),
    M.json(500, models.DeleteTaxAssociationResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
