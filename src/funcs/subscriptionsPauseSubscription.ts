...
export function subscriptionsPauseSubscription(
  ...
  Result<
    models.PauseSubscriptionResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.PauseSubscriptionRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PauseSubscriptionResponse$inboundSchema),
    M.json([400, 404], models.PauseSubscriptionResponse$inboundSchema),
    M.json(500, models.PauseSubscriptionResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
