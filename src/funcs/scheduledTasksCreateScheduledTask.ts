...
export function scheduledTasksCreateScheduledTask(
  ...
  Result<
    models.CreateScheduledTaskResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateScheduledTaskRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateScheduledTaskResponse$inboundSchema),
    M.json(400, models.CreateScheduledTaskResponse$inboundSchema),
    M.json(500, models.CreateScheduledTaskResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
