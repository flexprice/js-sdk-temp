...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoCreateInvoiceRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, operations.CreateInvoiceResponse$inboundSchema),
    M.json(500, operations.CreateInvoiceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
