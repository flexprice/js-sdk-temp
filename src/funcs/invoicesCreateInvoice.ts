...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateInvoiceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateInvoiceResponse$inboundSchema),
    M.json(400, models.CreateInvoiceResponse$inboundSchema),
    M.json(500, models.CreateInvoiceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
