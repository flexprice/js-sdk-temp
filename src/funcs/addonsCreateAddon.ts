...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateAddonRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, models.CreateAddonResponse$inboundSchema),
    M.json(500, models.CreateAddonResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
