 ...
 */
export function customerDashboardPostCustomerDashboardSubscriptions(
...
> {
  ...
  const path = pathToFunc("/customer-dashboard/subscriptions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.DtoListSubscriptionsResponse$inboundSchema),
