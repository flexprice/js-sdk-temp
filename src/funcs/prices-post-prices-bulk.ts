 ...
 */
export function pricesPostPricesBulk(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.DtoCreateBulkPriceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.DtoCreateBulkPriceResponse$inboundSchema),
