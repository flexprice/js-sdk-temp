...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreatePaymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreatePaymentResponse$inboundSchema),
    M.json(400, models.CreatePaymentResponse$inboundSchema),
    M.json(500, models.CreatePaymentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
