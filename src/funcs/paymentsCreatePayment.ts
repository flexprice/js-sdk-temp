...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoCreatePaymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreatePaymentResponse$inboundSchema),
    M.json(400, operations.CreatePaymentResponse$inboundSchema),
    M.json(500, operations.CreatePaymentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
