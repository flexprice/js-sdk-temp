 ...
 */
export function subscriptionsGetSubscriptionAddonAssociations(
  client: FlexpriceCore,
  request: models.GetSubscriptionAddonAssociationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GetSubscriptionAddonAssociationsResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.GetSubscriptionAddonAssociationsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/subscriptions/{id}/addons/associations")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetSubscriptionAddonAssociationsResponse$inboundSchema),
    M.json(
      [400, 404],
      models.GetSubscriptionAddonAssociationsResponse$inboundSchema,
    ),
    M.json(500, models.GetSubscriptionAddonAssociationsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
