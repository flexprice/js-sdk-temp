...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoGetEventsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListRawEventsResponse$inboundSchema),
    M.json(400, models.ListRawEventsResponse$inboundSchema),
    M.json(500, models.ListRawEventsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
