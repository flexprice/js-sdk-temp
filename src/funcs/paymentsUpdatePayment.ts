...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdatePaymentRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, operations.UpdatePaymentResponse$inboundSchema),
    M.json(500, operations.UpdatePaymentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
