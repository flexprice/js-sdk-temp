...
> {
  const parsed = safeParse(
    request,
    (value) => models.DeletePaymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeletePaymentResponse$inboundSchema),
    M.json([400, 404], models.DeletePaymentResponse$inboundSchema),
    M.json(500, models.DeletePaymentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
