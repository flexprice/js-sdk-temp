...
export function addonsGetAddonByLookupKey(
  ...
  Result<
    models.GetAddonByLookupKeyResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetAddonByLookupKeyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetAddonByLookupKeyResponse$inboundSchema),
    M.json(400, models.GetAddonByLookupKeyResponse$inboundSchema),
    M.json(500, models.GetAddonByLookupKeyResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
