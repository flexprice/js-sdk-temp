...
export function entitlementsQueryEntitlement(
  ...
  Result<
    models.QueryEntitlementResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.EntitlementFilter$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/entitlements/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.QueryEntitlementResponse$inboundSchema),
    M.json(400, models.QueryEntitlementResponse$inboundSchema),
    M.json(500, models.QueryEntitlementResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
