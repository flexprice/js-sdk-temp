...
export function entitlementsQueryEntitlement(
  ...
  Result<
    operations.QueryEntitlementResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.QueryEntitlementResponse$inboundSchema),
    M.json(400, operations.QueryEntitlementResponse$inboundSchema),
    M.json(500, operations.QueryEntitlementResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
