...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DtoCreateCustomerRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.json(400, operations.CreateCustomerResponse$inboundSchema),
    M.json(500, operations.CreateCustomerResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
