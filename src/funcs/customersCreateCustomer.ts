 ...
 */
export function customersCreateCustomer(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateCustomerRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateCustomerResponse$inboundSchema),
    M.json(400, models.CreateCustomerResponse$inboundSchema),
    M.json(500, models.CreateCustomerResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
