...
export function pricesUpdatePrice(
  ...
  Result<
    operations.UpdatePriceResponse,
    | FlexPriceError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdatePriceResponse$inboundSchema),
    M.json(400, operations.UpdatePriceResponse$inboundSchema),
    M.json(500, operations.UpdatePriceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
