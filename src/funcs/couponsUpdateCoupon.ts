...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateCouponRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateCouponResponse$inboundSchema),
    M.json([400, 401, 403, 404], models.UpdateCouponResponse$inboundSchema),
    M.json(500, models.UpdateCouponResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
