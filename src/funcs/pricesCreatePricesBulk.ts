...
export function pricesCreatePricesBulk(
  ...
  Result<
    models.CreatePricesBulkResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DtoCreateBulkPriceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreatePricesBulkResponse$inboundSchema),
    M.json(400, models.CreatePricesBulkResponse$inboundSchema),
    M.json(500, models.CreatePricesBulkResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
