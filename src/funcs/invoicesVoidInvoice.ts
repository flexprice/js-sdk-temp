...
> {
  const parsed = safeParse(
    request,
    (value) => operations.VoidInvoiceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.VoidInvoiceResponse$inboundSchema),
    M.json(400, operations.VoidInvoiceResponse$inboundSchema),
    M.json(500, operations.VoidInvoiceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
