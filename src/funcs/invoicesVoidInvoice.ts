...
> {
  const parsed = safeParse(
    request,
    (value) => models.VoidInvoiceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VoidInvoiceResponse$inboundSchema),
    M.json(400, models.VoidInvoiceResponse$inboundSchema),
    M.json(500, models.VoidInvoiceResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
