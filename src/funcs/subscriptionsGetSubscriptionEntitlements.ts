...
export function subscriptionsGetSubscriptionEntitlements(
  ...
  Result<
    models.GetSubscriptionEntitlementsResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.GetSubscriptionEntitlementsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetSubscriptionEntitlementsResponse$inboundSchema),
    M.json(
      [400, 404],
      models.GetSubscriptionEntitlementsResponse$inboundSchema,
    ),
    M.json(500, models.GetSubscriptionEntitlementsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
