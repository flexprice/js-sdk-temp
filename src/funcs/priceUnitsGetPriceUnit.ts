...
> {
  const parsed = safeParse(
    request,
    (value) => models.GetPriceUnitRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetPriceUnitResponse$inboundSchema),
    M.json([400, 404], models.GetPriceUnitResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
