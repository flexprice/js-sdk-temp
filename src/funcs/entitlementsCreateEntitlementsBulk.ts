...
export function entitlementsCreateEntitlementsBulk(
  ...
  Result<
    models.CreateEntitlementsBulkResponse,
    | FlexPriceError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.DtoCreateBulkEntitlementRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateEntitlementsBulkResponse$inboundSchema),
    M.json(400, models.CreateEntitlementsBulkResponse$inboundSchema),
    M.json(500, models.CreateEntitlementsBulkResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
