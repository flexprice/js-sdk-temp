...
/** @internal */
export declare const PricePriceTier$inboundSchema: z.ZodType<PricePriceTier, z.ZodTypeDef, unknown>;
export declare function pricePriceTierFromJSON(jsonString: string): SafeParseResult<PricePriceTier, SDKValidationError>;
//# sourceMappingURL=price-price-tier.d.ts.map