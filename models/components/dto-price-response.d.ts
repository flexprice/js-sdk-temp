...
import { PriceJSONBTransformQuantity } from "./price-jsonb-transform-quantity.js";
import { PricePriceTier } from "./price-price-tier.js";
...
/** @internal */
export declare const DtoPriceResponse$inboundSchema: z.ZodType<DtoPriceResponse, z.ZodTypeDef, unknown>;
export declare function dtoPriceResponseFromJSON(jsonString: string): SafeParseResult<DtoPriceResponse, SDKValidationError>;
//# sourceMappingURL=dto-price-response.d.ts.map