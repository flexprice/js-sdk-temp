...
/** @internal */
export declare const DtoCreateWalletRequest$outboundSchema: z.ZodType<DtoCreateWalletRequest$Outbound, z.ZodTypeDef, DtoCreateWalletRequest>;
export declare function dtoCreateWalletRequestToJSON(dtoCreateWalletRequest: DtoCreateWalletRequest): string;
//# sourceMappingURL=dto-create-wallet-request.d.ts.map