...
/** @internal */
export declare const DtoCreatePriceUnitRequest$outboundSchema: z.ZodType<DtoCreatePriceUnitRequest$Outbound, z.ZodTypeDef, DtoCreatePriceUnitRequest>;
export declare function dtoCreatePriceUnitRequestToJSON(dtoCreatePriceUnitRequest: DtoCreatePriceUnitRequest): string;
//# sourceMappingURL=dto-create-price-unit-request.d.ts.map