...
/** @internal */
export declare const DtoCouponResponse$inboundSchema: z.ZodType<DtoCouponResponse, z.ZodTypeDef, unknown>;
export declare function dtoCouponResponseFromJSON(jsonString: string): SafeParseResult<DtoCouponResponse, SDKValidationError>;
//# sourceMappingURL=dto-coupon-response.d.ts.map