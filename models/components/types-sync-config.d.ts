...
import { TypesEntitySyncConfig, TypesEntitySyncConfig$Outbound } from "./types-entity-sync-config.js";
import { TypesS3ExportConfig, TypesS3ExportConfig$Outbound } from "./types-s3-export-config.js";
...
//# sourceMappingURL=types-sync-config.d.ts.map