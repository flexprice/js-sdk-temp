 ...
 * Create a new tenant
 */
export declare function tenantsPostTenants(client: FlexPriceCore, request: components.DtoCreateTenantRequest, options?: RequestOptions): APIPromise<Result<components.DtoTenantResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=tenants-post-tenants.d.ts.map