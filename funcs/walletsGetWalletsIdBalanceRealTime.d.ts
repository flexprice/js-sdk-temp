 ...
 */
export declare function walletsGetWalletsIdBalanceRealTime(client: FlexPriceCore, id: string, options?: RequestOptions): APIPromise<Result<components.DtoWalletBalanceResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=walletsGetWalletsIdBalanceRealTime.d.ts.map