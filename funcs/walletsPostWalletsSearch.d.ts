 ...
 * List wallets by filter
 */
export declare function walletsPostWalletsSearch(client: FlexPriceCore, request?: components.TypesWalletFilter | undefined, options?: RequestOptions): APIPromise<Result<components.TypesListResponseDtoWalletResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=walletsPostWalletsSearch.d.ts.map