 ...
 */
export declare function webhooksPostWebhooksStripeTenantIdEnvironmentId(client: FlexPriceCore, tenantId: string, environmentId: string, stripeSignature: string, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=webhooks-post-webhooks-stripe-tenant-id-environment-id.d.ts.map