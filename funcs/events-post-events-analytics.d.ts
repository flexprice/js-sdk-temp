 ...
 */
export declare function eventsPostEventsAnalytics(client: FlexPriceCore, request: ReadableStream<Uint8Array> | Blob | ArrayBuffer | Uint8Array, options?: RequestOptions): APIPromise<Result<components.DtoGetUsageAnalyticsResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=events-post-events-analytics.d.ts.map