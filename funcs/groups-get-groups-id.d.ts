 ...
 * Get a group by ID
 */
export declare function groupsGetGroupsId(client: FlexPriceCore, id: string, options?: RequestOptions): APIPromise<Result<components.DtoGroupResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=groups-get-groups-id.d.ts.map