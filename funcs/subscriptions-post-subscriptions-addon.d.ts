 ...
 */
export declare function subscriptionsPostSubscriptionsAddon(client: FlexPriceCore, request: components.DtoAddAddonRequest, options?: RequestOptions): APIPromise<Result<components.DtoAddonAssociationResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=subscriptions-post-subscriptions-addon.d.ts.map