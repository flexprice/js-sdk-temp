 ...
 */
export declare function pricesGetPrices(client: FlexPriceCore, request: operations.GetPricesRequest, options?: RequestOptions): APIPromise<Result<components.DtoListPricesResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=prices-get-prices.d.ts.map