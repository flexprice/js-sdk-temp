 ...
 */
export declare function groupsPostGroups(client: FlexPriceCore, request: components.DtoCreateGroupRequest, options?: RequestOptions): APIPromise<Result<components.DtoGroupResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=groupsPostGroups.d.ts.map