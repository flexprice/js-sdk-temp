 ...
 */
export declare function eventsPostEvents(client: FlexPriceCore, request: components.DtoIngestEventRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: string;
...
//# sourceMappingURL=events-post-events.d.ts.map