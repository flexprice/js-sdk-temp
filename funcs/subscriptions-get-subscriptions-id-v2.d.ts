 ...
 */
export declare function subscriptionsGetSubscriptionsIdV2(client: FlexPriceCore, id: string, expand?: string | undefined, options?: RequestOptions): APIPromise<Result<components.DtoSubscriptionResponseV2, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=subscriptions-get-subscriptions-id-v2.d.ts.map