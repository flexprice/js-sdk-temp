 ...
 */
export declare function paymentsGetPayments(client: FlexPriceCore, request: operations.GetPaymentsRequest, options?: RequestOptions): APIPromise<Result<components.DtoListPaymentsResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=payments-get-payments.d.ts.map