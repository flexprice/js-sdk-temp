 ...
 */
export declare function couponsGetCoupons(client: FlexPriceCore, request: operations.GetCouponsRequest, options?: RequestOptions): APIPromise<Result<components.DtoListCouponsResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=coupons-get-coupons.d.ts.map