 ...
 */
export declare function priceUnitsPostPricesUnits(client: FlexPriceCore, request: components.DtoCreatePriceUnitRequest, options?: RequestOptions): APIPromise<Result<components.DtoCreatePriceUnitResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=price-units-post-prices-units.d.ts.map