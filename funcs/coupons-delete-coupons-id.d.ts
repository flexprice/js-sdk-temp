 ...
 * Deletes a coupon
 */
export declare function couponsDeleteCouponsId(client: FlexPriceCore, id: string, options?: RequestOptions): APIPromise<Result<{
    [k: string]: string;
...
//# sourceMappingURL=coupons-delete-coupons-id.d.ts.map