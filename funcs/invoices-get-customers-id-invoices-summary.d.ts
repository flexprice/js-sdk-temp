 ...
 * Get a customer invoice summary
 */
export declare function invoicesGetCustomersIdInvoicesSummary(client: FlexPriceCore, id: string, options?: RequestOptions): APIPromise<Result<components.DtoCustomerMultiCurrencyInvoiceSummary, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=invoices-get-customers-id-invoices-summary.d.ts.map