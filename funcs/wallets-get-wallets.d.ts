 ...
 */
export declare function walletsGetWallets(client: FlexPriceCore, request: operations.GetWalletsRequest, options?: RequestOptions): APIPromise<Result<components.TypesListResponseDtoWalletResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=wallets-get-wallets.d.ts.map