 ...
 * List connections by filter
 */
export declare function connectionsPostConnectionsSearch(client: FlexPriceCore, request: components.TypesConnectionFilter, options?: RequestOptions): APIPromise<Result<components.DtoListConnectionsResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=connections-post-connections-search.d.ts.map