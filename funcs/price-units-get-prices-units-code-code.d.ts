 ...
 * Get a price unit by code
 */
export declare function priceUnitsGetPricesUnitsCodeCode(client: FlexPriceCore, code: string, options?: RequestOptions): APIPromise<Result<components.DtoPriceUnitResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=price-units-get-prices-units-code-code.d.ts.map