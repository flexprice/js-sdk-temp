 ...
 * Get a price unit by ID
 */
export declare function priceUnitsGetPricesUnitsId(client: FlexPriceCore, id: string, options?: RequestOptions): APIPromise<Result<components.DtoPriceUnitResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=price-units-get-prices-units-id.d.ts.map