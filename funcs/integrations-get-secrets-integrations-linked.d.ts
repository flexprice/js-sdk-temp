 ...
 */
export declare function integrationsGetSecretsIntegrationsLinked(client: FlexPriceCore, options?: RequestOptions): APIPromise<Result<components.DtoLinkedIntegrationsResponse, errors.ErrorsErrorResponse | FlexPriceError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=integrations-get-secrets-integrations-linked.d.ts.map