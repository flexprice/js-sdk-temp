...
import { usersCreateUser } from "flexprice-ts-temp/funcs/usersCreateUser.js";
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.DtoCreateUserRequest](../../sdk/models/dtocreateuserrequest.md)                                                                                                        | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
```typescript
import { FlexpriceCore } from "flexprice-ts-temp/core.js";
import { usersGetUserInfo } from "flexprice-ts-temp/funcs/usersGetUserInfo.js";
...
**Promise\<[models.GetUserInfoResponse](../../sdk/models/getuserinforesponse.md)\>**
...
```typescript
import { FlexpriceCore } from "flexprice-ts-temp/core.js";
import { usersQueryUser } from "flexprice-ts-temp/funcs/usersQueryUser.js";
...
**Promise\<[models.QueryUserResponse](../../sdk/models/queryuserresponse.md)\>**
