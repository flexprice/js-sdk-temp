...
import { scheduledTasksCreateScheduledTask } from "@flexprice/sdk-temp/funcs/scheduledTasksCreateScheduledTask.js";
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [shared.DtoCreateScheduledTaskRequest](../../sdk/models/shared/dtocreatescheduledtaskrequest.md)                                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.CreateScheduledTaskResponse](../../sdk/models/operations/createscheduledtaskresponse.md)\>**
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk-temp/core.js";
import { scheduledTasksDeleteScheduledTask } from "@flexprice/sdk-temp/funcs/scheduledTasksDeleteScheduledTask.js";
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk-temp/core.js";
import { scheduledTasksGetScheduledTask } from "@flexprice/sdk-temp/funcs/scheduledTasksGetScheduledTask.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetScheduledTaskRequest](../../sdk/models/operations/getscheduledtaskrequest.md)                                                                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetScheduledTaskResponse](../../sdk/models/operations/getscheduledtaskresponse.md)\>**
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk-temp/core.js";
import { scheduledTasksListScheduledTasks } from "@flexprice/sdk-temp/funcs/scheduledTasksListScheduledTasks.js";
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk-temp/core.js";
import { scheduledTasksScheduleUpdateBillingPeriod } from "@flexprice/sdk-temp/funcs/scheduledTasksScheduleUpdateBillingPeriod.js";
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk-temp/core.js";
import { scheduledTasksTriggerScheduledTaskRun } from "@flexprice/sdk-temp/funcs/scheduledTasksTriggerScheduledTaskRun.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.TriggerScheduledTaskRunRequest](../../sdk/models/operations/triggerscheduledtaskrunrequest.md)                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk-temp/core.js";
import { scheduledTasksUpdateScheduledTask } from "@flexprice/sdk-temp/funcs/scheduledTasksUpdateScheduledTask.js";
