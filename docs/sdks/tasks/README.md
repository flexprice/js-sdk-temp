...
async function run() {
  const result = await flexPrice.tasks.getTasks({});
...
async function run() {
  const res = await tasksGetTasks(flexPrice, {});
  if (res.ok) {
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("tasksPostTasks failed:", res.error);
  }
}
...
async function run() {
  const result = await flexPrice.tasks.getTasksResult("<id>");
...
async function run() {
  const res = await tasksGetTasksResult(flexPrice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("tasksGetTasksResult failed:", res.error);
  }
}
...
async function run() {
  const result = await flexPrice.tasks.getTasksId("<id>");
...
async function run() {
  const res = await tasksGetTasksId(flexPrice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("tasksGetTasksId failed:", res.error);
  }
}
...
async function run() {
  const result = await flexPrice.tasks.putTasksIdStatus("<id>", {
...
async function run() {
  const res = await tasksPutTasksIdStatus(flexPrice, "<id>", {
    taskStatus: "COMPLETED",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("tasksPutTasksIdStatus failed:", res.error);
  }
}
