...
<!-- UsageSnippet language="typescript" operationID="get_/connections" method="get" path="/connections" -->
```typescript
...
async function run() {
  const result = await flexPrice.connections.getConnections({});
...
async function run() {
  const res = await connectionsGetConnections(flexPrice, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("connectionsGetConnections failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="post_/connections/search" method="post" path="/connections/search" -->
```typescript
import { FlexPrice } from "flexprice-sdk-test";
...
async function run() {
  const result = await flexPrice.connections.postConnectionsSearch({});
...
async function run() {
  const res = await connectionsPostConnectionsSearch(flexPrice, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("connectionsPostConnectionsSearch failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="get_/connections/{id}" method="get" path="/connections/{id}" -->
```typescript
import { FlexPrice } from "flexprice-sdk-test";
...
async function run() {
  const result = await flexPrice.connections.getConnectionsId("<id>");
...
async function run() {
  const res = await connectionsGetConnectionsId(flexPrice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("connectionsGetConnectionsId failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="put_/connections/{id}" method="put" path="/connections/{id}" -->
```typescript
import { FlexPrice } from "flexprice-sdk-test";
...
async function run() {
  const result = await flexPrice.connections.putConnectionsId("<id>", {});
...
async function run() {
  const res = await connectionsPutConnectionsId(flexPrice, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("connectionsPutConnectionsId failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="delete_/connections/{id}" method="delete" path="/connections/{id}" -->
```typescript
import { FlexPrice } from "flexprice-sdk-test";
...
async function run() {
  await flexPrice.connections.deleteConnectionsId("<id>");
...
async function run() {
  const res = await connectionsDeleteConnectionsId(flexPrice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    
  } else {
    console.log("connectionsDeleteConnectionsId failed:", res.error);
  }
}
