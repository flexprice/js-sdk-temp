...
```typescript
import { DtoGetDetailedCostAnalyticsResponse } from "flexprice-ts-temp/sdk/models";
...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `costAnalytics`                                                         | [models.DtoCostAnalyticItem](../../sdk/models/dtocostanalyticitem.md)[] | :heavy_minus_sign:                                                      | Cost analytics array (flattened from nested structure)                  |
