...
```typescript
import { DtoSubscriptionChangePreviewResponse } from "flexprice-ts-temp/sdk/models/shared";
...
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `changeType`                                                                          | [shared.SubscriptionChangeType](../../../sdk/models/shared/subscriptionchangetype.md) | :heavy_minus_sign:                                                                    | N/A                                                                                   |
