...
```typescript
import { DtoGetDetailedCostAnalyticsResponse } from "@flexprice/sdk-temp/sdk/models/shared";
...
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| `costAnalytics`                                                                   | [shared.DtoCostAnalyticItem](../../../sdk/models/shared/dtocostanalyticitem.md)[] | :heavy_minus_sign:                                                                | Cost analytics array (flattened from nested structure)                            |
