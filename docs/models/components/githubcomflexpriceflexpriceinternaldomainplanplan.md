...
```typescript
import { GithubComFlexpriceFlexpriceInternalDomainPlanPlan } from "flexprice-sdk-test/models/components";

let value: GithubComFlexpriceFlexpriceInternalDomainPlanPlan = {};
```
