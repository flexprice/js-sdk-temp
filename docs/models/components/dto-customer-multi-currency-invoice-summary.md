...
| `summaries`                                                                                       | [components.DtoCustomerInvoiceSummary](../../models/components/dto-customer-invoice-summary.md)[] | :heavy_minus_sign:                                                                                | summaries contains the invoice summaries for each currency                                        |