...
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| `aggregation`                                                               | [components.MeterAggregation](../../models/components/meter-aggregation.md) | :heavy_minus_sign:                                                          | N/A                                                                         |                                                                             |
...
| `resetUsage`                                                                | [components.TypesResetUsage](../../models/components/types-reset-usage.md)  | :heavy_minus_sign:                                                          | N/A                                                                         |                                                                             |
