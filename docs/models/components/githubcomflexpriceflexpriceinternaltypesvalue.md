...
```typescript
import { GithubComFlexpriceFlexpriceInternalTypesValue } from "flexprice-sdk-test/models/components";
...
| ------------------ | ------------------ | ------------------ | ------------------ |
| `array`            | *string*[]         | :heavy_minus_sign: | N/A                |
| `boolean`          | *boolean*          | :heavy_minus_sign: | N/A                |
