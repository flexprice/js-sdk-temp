...
const sdk_validation_error_js_1 = require("../models/errors/sdk-validation-error.js");
...
function parse(rawValue, fn, errorMessage) {
    try {
        ...
        if (err instanceof v3_1.ZodError) {
            throw new sdk_validation_error_js_1.SDKValidationError(errorMessage, err, rawValue);
        }
        throw err;
    }
}
...
function safeParse(rawValue, fn, errorMessage) {
    try {
        ...
        return (0, fp_js_1.ERR)(new sdk_validation_error_js_1.SDKValidationError(errorMessage, err, rawValue));
    }
}
