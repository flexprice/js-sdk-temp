...
const http_client_errors_js_1 = require("../models/errors/http-client-errors.js");
...
class ClientSDK {
    constructor(options) {
        ...
        const defaultHttpClient = new http_js_1.HTTPClient();
    ...
    _createRequest(context, conf, options) {
        ...
        if (!base) {
            return (0, fp_js_1.ERR)(new http_client_errors_js_1.InvalidRequestError("No base URL provided for operation"));
        }
        ...
        try {
            ...
            return (0, fp_js_1.ERR)(new http_client_errors_js_1.UnexpectedClientError("Create request hook failed to execute", {
                cause: err,
            }));
        }
        ...
        return (0, retries_js_1.retry)(async () => {
            ...
            switch (true) {
                case (0, http_js_1.isAbortError)(err):
                    return (0, fp_js_1.ERR)(new http_client_errors_js_1.RequestAbortedError("Request aborted by client", {
                        cause: err,
                    }));
                case (0, http_js_1.isTimeoutError)(err):
                    return (0, fp_js_1.ERR)(new http_client_errors_js_1.RequestTimeoutError("Request timed out", { cause: err }));
                case (0, http_js_1.isConnectionError)(err):
                    return (0, fp_js_1.ERR)(new http_client_errors_js_1.ConnectionError("Unable to make request", { cause: err }));
                default:
                    return (0, fp_js_1.ERR)(new http_client_errors_js_1.UnexpectedClientError("Unexpected HTTP client error", {
                        cause: err,
                    }));
            }
        });
