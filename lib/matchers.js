...
const response_validation_error_js_1 = require("../models/errors/response-validation-error.js");
const sdk_error_js_1 = require("../models/errors/sdk-error.js");
...
function match(...matchers) {
    return async function matchFunc(response, request, options) {
        ...
        if (!matcher) {
            return [{
                    ok: false,
                    error: new sdk_error_js_1.SDKError("Unexpected Status or Content-Type", {
                        response,
                        request,
        ...
        if (matcher.enc === "fail") {
            return [{
                    ok: false,
                    error: new sdk_error_js_1.SDKError("API error occurred", { request, response, body }),
                }, raw];
        }
...
function safeParseResponse(rawValue, fn, errorMessage, httpMeta) {
    try {
        ...
        return (0, fp_js_1.ERR)(new response_validation_error_js_1.ResponseValidationError(errorMessage, {
            cause: err,
            rawValue,
